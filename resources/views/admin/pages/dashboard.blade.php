            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Data Ekskul</p>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Data Kriteria</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{-- {{ $userTotal ?? '0' }} --}}
                                </h5>
                            </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Data Riwayat</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{-- {{ $barangTotal ?? '0' }} --}}
                                </h5>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d-flex flex-column h-100 justify-content-center mx-5">
                                ...
                                <h4 class="font-weight-bolder">{{ Auth::user()->nama }}</h4>
